...
router.get('/', function(req, res, next) {
  res.render('index', { title: 'Codet - a platform for sharing code.' });
});

router.get('/about', function(req, res, next) {
  res.render('about', { title: 'Codet - a platform for sharing code.'});
});
...
router.route('/contact')
  ...
  .post(function(req, res, next) {
    ...
    if(errors) {
      res.render('contact', {
        title: 'Codet - a platform for sharing code.',
        name: req.body.name,
      ...
      var mailOptions = {
        from: 'Codet <no-reply@code4share.com>',
